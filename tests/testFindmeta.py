...
class testFindmetaMethods(unittest.TestCase):
    ...
    def test_getPlaylistTracks(self):
        tracks = findmeta.getPlaylistTracks(user="Spotify", playlist_id="37i9dQZF1DXcBWIGoYBM5M") # Uses Today's Top Hits Playlist
        self.assertGreaterEqual(tracks[0]["Popularity"], tracks[1]["Popularity"])
